  ...
  return (
    <section className="bg-gray-100 py-12">
      <div className="container mx-auto text-center">
        <h2 className=" font-bold mb-8">Our Achievements</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div ref={ref} className="stat-item p-6  rounded-lg shadow-lg">
            <GiHouseKeys className="text-4xl text-black mx-auto mb-4" />
            <p className=" font-semibold">Homes Rented</p>
            {inView && <CountUp end={150} duration={8} className="text-2xl font-bold" />}
          </div>
          <div ref={ref} className="stat-item p-6  rounded-lg shadow-lg">
            <FaHandshake className="text-4xl text-black mx-auto mb-4" />
